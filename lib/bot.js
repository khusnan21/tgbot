...
Hi ${msg.from.first_name} 😉️, <b>What Can I Do  👇️,</b>
 ...
 - <code>Save your torrent on Drive</code>
 - <code>UGive you drive link</code>
 - <code>If you loved thsi bot follow me on twitter.com/gr8mawiya</code>

⚠️ Search is not working
⚠️ No Longer support for Groups
⚠️ Server status Hidden 
🖥️ OVH - US 2TB - 8cpu -32GBram 
  ...
  bot.onText(downloadRegex, (msg, match) => {
    ...
    const reply = async torr => {
      ...
      if (!torr.done) {
        ...
        mess1 += `<b>Download Link 🔗:</b> Generating... \n\n`;
