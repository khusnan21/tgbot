...
var msg_buttons = {
      reply_markup: {
        inline_keyboard: [
          [{ text: "🔰  YOU CAN ADD ME IN GROUPS 🔰", url: "https://google.com" }],
        ]
      },
      parse_mode : "HTML"
    };
...
I am telegram bot who can search and download torrents to Dropbox and Google Drive upto 100GB files.
You can download torrents from my Drive or watch online if file is video.

Download Speed can be slow because of less SEEDS or Server load.

Files will be kept for few days maybe a month then deleted from drive.

<b>What Can I Do  👇️ amd how to use.</b>

 - <code>Search Across Torrent Sites For Your Keyword</code>
Search sites : piratebay|limetorrent|1337x
 /search piratebay Mawiya 
 
 - <code>Mirror Magnet Links to Our Team Drive</code>
/download magnet:linkhere

- <code> Get torrent details </code>
/details {site} {link}

 - <code>Upload Telegram Files to Our Team Drive</code>
It now automatic you don't need to do anything...

 - <code>Get Status of a Magnet Link</code>
/status magnet:youpastedindownload
...
<code>/search site name - To search for torrent use replace site & nane
...
//   });
  ...
  bot.onText(downloadRegex, (msg, match) => {
    ...
    if (link.indexOf("magnet:") !== 0) {
      ...
      bot.sendMessage(from, "<code>📩️ Starting to download 📩️...</code>", {parse_mode : "HTML"});
      try {
